...
{
  int sR;    //!< start coordinate in the reference
  int eR;    //!< end coordinate in the reference
  int sQ;    //!< start coordinate in the reference
  int eQ;    //!< end coordinate in the reference
  int idyc;  //!< number of mismatches in the alignment
  ...
  std::vector<int> deltas;  //!< delta encoded alignment informaiton
