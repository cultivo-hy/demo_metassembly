...
/* Define to 1 if `ext_atomic_cap' is a member of `struct
   ibv_exp_device_attr'. */
/* #undef HAVE_STRUCT_IBV_EXP_DEVICE_ATTR_EXT_ATOMIC_CAP */
...
#define MCA_io_romio314_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -pthread -D__EXTENSIONS__' CPPFLAGS='  -I/home/ubuntu/tool/openmpi-2.1.1/opal/mca/hwloc/hwloc1112/hwloc/include -I/home/ubuntu/tool/openmpi-2.1.1/opal/mca/event/libevent2022/libevent -I/home/ubuntu/tool/openmpi-2.1.1/opal/mca/event/libevent2022/libevent/include' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static   --disable-aio --disable-weak-symbols --enable-strict"
...
#define OMPI_TARBALL_VERSION "2.1.1"
...
#define OPAL_IDENT_STRING "2.1.1"
...
#define OPAL_PACKAGE_STRING "Open MPI ubuntu@ip-172-30-0-135 Distribution"
...
#define OPAL_RELEASE_DATE "May 10, 2017"
...
#define OPAL_REPO_REV "v2.1.0-100-ga2fdb5b"
...
#define OPAL_TARBALL_VERSION "2.1.1"
...
#define ORTE_RELEASE_DATE "May 10, 2017"
...
#define ORTE_REPO_REV "v2.1.0-100-ga2fdb5b"

/* Tarball filename version string of Open MPI Run-Time Environment */
#define ORTE_TARBALL_VERSION "2.1.1"
...
#define OSHMEM_TARBALL_VERSION "2.1.1"
...
#define PACKAGE_STRING "Open MPI 2.1.1"
